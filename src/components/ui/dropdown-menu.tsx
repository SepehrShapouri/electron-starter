...
const dropdownContentClassName =
  "bg-popover text-popover-foreground data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 ring-foreground/10 overflow-hidden rounded-lg shadow-fancy ring-1 duration-100 data-[side=inline-start]:slide-in-from-right-2 data-[side=inline-end]:slide-in-from-left-2 relative z-50 max-h-(--available-height) w-(--anchor-width) origin-(--transform-origin) outline-none data-closed:overflow-hidden"
    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(dropdownContentClassName, "min-w-32 p-1 overflow-y-auto", className )}
          {...props}
        />
      </MenuPrimitive.Positioner>
    </MenuPrimitive.Portal>
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <AppIcon name="IconChevronRightMedium" className="ml-auto" />
    </MenuPrimitive.SubmenuTrigger>
  )
}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(dropdownContentClassName, "min-w-[96px] w-auto p-1 overflow-y-auto", className)}
      align={align}
      alignOffset={alignOffset}
      side={side}
      sideOffset={sideOffset}
