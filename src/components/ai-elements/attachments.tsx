...
const mediaCategoryIcons: Record<AttachmentMediaCategory, string> = {
  audio: "IconAudio",
  document: "IconFileText",
  image: "IconImages3",
  source: "IconFolder1",
  unknown: "IconFileBend",
  video: "IconVideos",
};
  ...
  return (
    <div
      className={cn(
        ...
        variant === "inline" && "size-5 rounded-[6px] bg-background",
...
export const AttachmentRemove = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <AppIcon fallbackName="IconCircle" name="IconCrossMedium" />}
