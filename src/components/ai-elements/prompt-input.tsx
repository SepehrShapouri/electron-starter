...
type PromptInputSubmitClick = NonNullable<PromptInputSubmitProps["onClick"]>;
...
export const PromptInputSubmit = ({
  ...
  let Icon = (
    <AppIcon
      className="size-4"
      fallbackName="IconArrowDownLeft"
  ...
  if (status === "submitted") {
    ...
    Icon = (
      <AppIcon className="size-4" fallbackName="IconCircle" name="IconStop" />
    );
  ...
  const handleClick = useCallback<PromptInputSubmitClick>(
    (e) => {
